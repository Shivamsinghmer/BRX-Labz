    ...
    return (
        <section className="relative min-h-screen w-full flex flex-col items-center justify-center  pb-12 px-4 overflow-hidden">
            ...
            <div className="flex items-center gap-2 px-3 py-1 rounded-full border border-primary/20 bg-primary/5 backdrop-blur-md mb-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                <span className="text-xs font-medium tracking-wide text-primary/80 uppercase">Available for new Projects</span>
            </div>

            {/* Main Content */}
            <div className="max-w-4xl w-full text-center space-y-4">
                <h2 className="text-lg md:text-lg font-medium tracking-widest text-primary/60 text-primary/40 uppercase animate-in fade-in slide-in-from-bottom-5 duration-1000 delay-100">
                ...
                <h1 className="text-3xl md:text-6xl font-black tracking-tight leading-tight bg-clip-text text-transparent bg-linear-to-b from-primary to-primary/60 from-white to-white/40 animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-200">
                    We Build Websites That Turn Visitors Into Customers.
                </h1>

                <p className="max-w-xl mx-auto text-sm md:text-base text-primary/60 text-primary/40 font-medium leading-relaxed animate-in fade-in slide-in-from-bottom-7 duration-1000 delay-300">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-6 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-400">
                    <Link href="https://cal.com/brx-labz/30min">
                        <InteractiveHoverButton className="invert border-none text-primary h-12 px-8 text-base">
                            Start Your Project
