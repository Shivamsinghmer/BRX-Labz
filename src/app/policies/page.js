...
const PoliciesPage = () => {
  return (
    <div className="min-h-screen pt-32 pb-20 px-4 md:px-8 max-w-5xl mx-auto">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-foreground to-foreground/40 mb-6">
          Legal Policies
        </h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Transparency is key to our relationship. Please read our terms and policies carefully to understand how we operate and protect your rights.
        </p>
      </motion.div>

      <div className="grid grid-cols-1 md:grid-cols-[250px_1fr] gap-12 relative">
        {/* Sidebar Navigation */}
        <aside className="hidden md:block">
          <div className="sticky top-32 space-y-2">
            <p className="font-medium text-foreground mb-4 px-3">Contents</p>
            {navItems.map((item) => (
              <a
                key={item.id}
                href={`#${item.id}`}
        ...
        <main>
          <Section id="terms" title="Terms & Conditions">
            ...
            <p>
              This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <a href="https://brxlabz.vercel.app/" className="text-primary hover:underline">https://brxlabz.vercel.app/</a> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
            </p>
            <p>
              The Platform is owned by <strong>BRXLabz</strong>, a company incorporated under the Companies Act, 1956 with its registered office at <strong>37E7 Dabouli Kanpur Uttar Pradesh</strong> (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
            </p>
            <p>
            ...
            <div className="bg-muted/30 p-4 border-l-2 border-primary my-6">
            ...
            <ul className="list-disc pl-5 space-y-3 marker:text-muted-foreground/50">
              ...
              <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Kanpur, Uttar Pradesh.</li>
          ...
          <Section id="privacy" title="Privacy Policy">
            ...
            <h3 className="text-xl font-medium text-foreground mt-8 mb-4">Sharing</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-foreground mt-8 mb-4">Security Precautions</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-foreground mt-8 mb-4">Data Deletion and Retention</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-foreground mt-8 mb-4">Your Rights</h3>
            <p>
              You may access, rectify, and update your personal data directly through the functionalities provided on the Platform.
            </p>

            <h3 className="text-xl font-medium text-foreground mt-8 mb-4">Consent</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-foreground mt-8 mb-4">Changes to this Privacy Policy</h3>
            <p>
            ...
            <div className="bg-muted p-6 rounded-lg mt-8">
              <h4 className="text-lg font-medium text-foreground mb-4">Grievance Officer</h4>
              <p className="text-sm">Please find below the details of the grievance officer:</p>
              <div className="mt-4 grid gap-2 text-sm">
                <p><span className="font-semibold">Office:</span> 37E7 Dabouli Kanpur Uttar Pradesh</p>
                <p><span className="font-semibold">Company:</span> BRXLabz</p>
                <p className="mt-2"><span className="font-semibold">Contact us:</span></p>
                <p>Phone availability: Monday - Friday (9:00 - 18:00)</p>
              </div>
            </div>
          </Section>

          <Section id="refund" title="Refund and Cancellation Policy">
            <p>
              This refund and cancellation policy outlines how you can cancel or seek a refund for a product / service that you have purchased through the Platform. Under this policy:
            </p>
            <ul className="list-disc pl-5 space-y-3 mt-4 marker:text-muted-foreground/50">
              ...
              <li>BRXLabz does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good.</li>
              ...
              <li>In case of any refunds approved by BRXLabz, it will take 7 days for the refund to be processed to you.</li>
            </ul>
          </Section>
